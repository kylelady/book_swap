...
class DataControllerTest < ActionController::TestCase
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post :create, :datum => { :author => @datum.author, :edition => @datum.edition, :isbn => @datum.isbn, :title => @datum.title }
    end
  ...
  test "should update datum" do
    put :update, :id => @datum, :datum => { :author => @datum.author, :edition => @datum.edition, :isbn => @datum.isbn, :title => @datum.title }
    assert_redirected_to datum_path(assigns(:datum))
  end
